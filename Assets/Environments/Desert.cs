...
public class Desert
{
    public static string meshTag = "SandFloor";
    ...
    private static AnimationCurve setCurve()
    {
        AnimationCurve curve = new AnimationCurve(
            new Keyframe(0, 0f), new Keyframe(1.08f, 1.50f)    
        );
    ...
    private static Gradient setGradient()
    {
        ...
        gradientColorKeys[0].color = new Color(0.97f, 0.87f, 0.0f);
        gradientColorKeys[0].time = 0.0f;
        gradientColorKeys[1].color = new Color(0.97f, 0.67f, 0.14f);
        gradientColorKeys[1].time = 0.3f;
        gradientColorKeys[2].color = new Color(0.93f, 0.10f, 0.04f);
        gradientColorKeys[2].time = 0.75f;
        gradientColorKeys[3].color = new Color(0.00f, 0.00f, 0.00f);
